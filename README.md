lagrange
==============
Math for Electronics 2 Assignment. Applying Lagrange interpolation for predicting data (extrapolation)


Lagrange for interpolating data.
...
Test : 
<img src="images/ss2.png" alt="error"/>
Output : 
<img src="images/ss3.png" alt="error"/>
